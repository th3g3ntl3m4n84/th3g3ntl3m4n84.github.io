...
```bash
─[us-dedivip-1]─[10.10.16.232]─[jpfguedes@htb]─[~/htb/Machines/images/exploitation]
...
```bash
─[us-dedivip-1]─[10.10.16.232]─[jpfguedes@htb]─[~/htb/images/exploitation]
...
```bash
─[us-dedivip-1]─[10.10.16.232]─[jpfguedes@htb]─[~/htb/images/exploitation/vpn-segment]
...
```bash
─[us-dedivip-1]─[10.10.16.232]─[jpfguedes@htb]─[~/htb/images/exploitation/web-segment]
...
```bash
─[us-dedivip-1]─[10.10.16.173]─[jpfguedes@htb]─[~/htb/images/exploitation/web-segment]
...
```bash
─[us-dedivip-1]─[10.10.16.200]─[jpfguedes@htb]─[~/htb/images/exploitation/user]
└──╼ [★]$ cat id_rsa
